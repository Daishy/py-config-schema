...
class Token(object):
    ...
    def __add__(self, other):
        ...
        """
        raise SchemaError(u"Tried to merge token {} and {}, which is not possible!".format(self, other))
...
class ValueToken(Token):
    ...
    def __init__(self, value_type, required=True, desc=None, default=None):
        """
    ...
    def validate(self, value):
        ...
        if self.required and value == None:
            raise ValidationError(u"ValueToken '{}'' is required, but value was None".format(self.name))
        if value != None and not isinstance(value, self.value_type):
            raise ValidationError(u"ValueToken '{}'' expected {} but got {} (Value: {})".format(self.name, self.value_type, type(value), value))
    ...
    def __repr__(self):
        return u"<ValueToken '{}'' ({})>".format(self.name, self.value_type)
...
class DecoratorToken(Token):
    ...
    def __init__(self):
        super(DecoratorToken, self).__init__()
